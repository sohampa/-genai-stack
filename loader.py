...
# if Neo4j is local, you can go to http://34.225.254.177:7474/ to browse the database
...
def render_page():
    ...
    st.caption("Go to http://34.225.254.177:7474/ to explore the graph.")
    ...
    if st.button("Import", type="primary"):
        with st.spinner("Loading... This might take a minute or two."):
            try:
                ...
                st.caption("Go to http://34.225.254.177:7474/ to interact with the database")

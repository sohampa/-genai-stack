...
|---|---|---|---|---|
| Support Bot | `bot.py` | `bot` | http://34.225.254.177:8501 | Main usecase. Fullstack Python application. |
| Stack Overflow Loader | `loader.py` | `loader` | http://34.225.254.177:8502 | Load SO data into the database (create vector embeddings etc). Fullstack Python application. |
| PDF Reader | `pdf_bot.py` | `pdf_bot` | http://34.225.254.177:8503 | Read local PDF and ask it questions. Fullstack Python application. |
| Standalone Bot API | `api.py` | `api` | http://34.225.254.177:8504 | Standalone HTTP API streaming (SSE) + non-streaming endpoints Python. |
| Standalone Bot UI | `front-end/` | `front-end` | http://34.225.254.177:8505 | Standalone client that uses the Standalone Bot API to interact with the model. JavaScript (Svelte) front-end. |

The database can be explored at http://34.225.254.177:7474.

## App 1 - Support Agent Bot

UI: http://34.225.254.177:8501
DB client: http://34.225.254.177:7474
...
Endpoints: 
  - http://34.225.254.177:8504/query?text=hello&rag=false (non streaming)
  - http://34.225.254.177:8504/query-stream?text=hello&rag=false (SSE streaming)

Example cURL command:
```bash
curl http://34.225.254.177:8504/query-stream\?text\=minimal%20hello%20world%20in%20python\&rag\=false
```
